...
#'\itemize{
#'     \item DB_READY The database matched from the 2 initial BDDs with common covariates and imputed or not accordind to the impute option.
#'     \item Y1_LEVELS Levels retained for the target variable in the DB1.
#'     \item Y2_LEVELS Levels retained for the target variable in the DB2.
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
...
=======
#' # Require samp.A database from the StatMatch package.
#' # c.neti and c.neti.bis coded voluntarily in 2 distinct encodings.
#' library(StatMatch)
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
#' data(samp.A)
#' 
...
#' "c.neti","c.neti.bis",
#' order_levels_Y1 = NULL, order_levels_Y2 = NULL,
#' ordinal_DB1 = c(2,4,6,9), ordinal_DB2 = c(1,3,9),
...
#' ordinal_DB1 = c(2,4,6,9), ordinal_DB2 = c(1,3,9),
#' impute = "MICE")
#' soluc6  = merge_dbs(data3,data4,
#' NAME_Y1 = "c.neti",NAME_Y2 = "c.neti.bis",
#' order_levels_Y2 = c("4","1","3","2"),
#' ordinal_DB1 = c(2,4,6,9), ordinal_DB2 = c(1,3,9),
#' impute = "NO")
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
#'
...
merge_dbs = function(DB1,
                     ...
                     NAME_Y1,
                     NAME_Y2,
                     order_levels_Y1 = levels(DB1[, NAME_Y1]),
                     order_levels_Y2 = levels(DB2[, NAME_Y2]),
                     ordinal_DB1 = FALSE,
                     ordinal_DB2 = FALSE,
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
                     impute = "NO",
...
=======
  ...
  if ((is.character(NAME_Y1) != TRUE) |
      (is.character(NAME_Y2) != TRUE)) {
...
=======
  ...
  if (impute == "CC") {
    ...
    DB1_new = stats::na.omit(DB1[, setdiff(names(DB1), NAME_Y1)])
    DB2_new = stats::na.omit(DB2[, setdiff(names(DB2), NAME_Y2)])
    
  } else if (impute == "MICE") {
    DB1bis       = imput_cov(
      DB1[, setdiff(names(DB1), NAME_Y1)],
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
      R_mice = R_MICE,
      meth = typ_cov_DB1b,
      missMDA = FALSE,
...
=======
        Y1_LEVELS = levels(DB_COV$Y1),
        Y2_LEVELS = levels(DB_COV$Y2),
>>>>>>> 6f4cbad61224e0f392a0d80f4240360f0a0367ae
        REMOVE1 = remove_var1,
        REMOVE2 = remove_var2,
