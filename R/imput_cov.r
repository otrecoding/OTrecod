...
#' The output \code{MICE_IMPS} stored the imputed databases permits users to build other consensus values by themselves, and to assess the variabilities related to the imputed values, if necessary.
...
#'
#' @examples
#' # By example, to impute all incomplete covariates in the table simu_data:
#' data(simu_data)
#'
