...
#' It corresponds to a sample of the data \code{\link[survey]{api}} from the package \pkg{survey}, related to the results of the
#' county 35.
#' The database contains information for the 362 schools of this county having at least 100 students.
#' Missing information has been randomly (and voluntary) added to the \code{award} and \code{ell} variables (4\% and 7\% respectively).
...
#'   \item{apicl_1999}{API score in 1999 classed in 4 ordered levels: \code{G1},\code{G2},\code{G3}, \code{G4}}
...
#'   \item{full}{The percentage of fully qualified teachers stored in a in a 2-levels factor: \code{1}: For strictly less than 90\%, \code{2} otherwise}
#' }
#'
