...
of the package survey, related to the results of the county 29 (Nevada).
The database contains information for the 418 schools of this county
having at least 100 students. Missing information has been randomly (and
voluntary) added to the `awards` and `ell` variables (4% and 7%
respectively). Several variables have been voluntary categorized from
their initial types.
...
- apicl_2000:
  ...
  the API score in 2000 classed in 3 ordered levels:
  `[200-600]`,`(600-800]`,`(800-1000]`
...
- mobility:
  ...
  school, stored in 2 levels: `[0-20]` and `(20-100]`
